...
<html>
<head>
  <title>Display Attended Events</title>
  <meta charset="utf-8">
  ...
  <?php
     $con=mysqli_connect('localhost','root');
       ...
       if (isset($_POST['search'])) {
        ...
        $sql="SELECT * FROM attended where event_title like '%$searchKey%' or faculty_id like '$searchKey'";
       }
       else{
        $sql="SELECT * FROM attended";
        $searchKey="";
...
<div class="container"> 
<br> 
<h3 class="text-center">LIST OF ATTENDED EVENTS</h3><br />  
         <div class="table-responsive" id="event_management">  
                  ...
                  <div class="row">
                    <div class="col">
                      <FORM action="displayattended.php" method="post">
                    ...
                    <div class="col">
                      <div>
                          <button class="btn btn-dark float-right" style="align-content: right">
                            <a href="displayattended.php" style="color: white;">Refresh</a>
                          </button>
                      </div>
                    </div>
