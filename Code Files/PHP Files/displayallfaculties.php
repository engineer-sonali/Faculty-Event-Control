...
<html>
<head>
  <title>Display All Faculties</title>
  <meta charset="utf-8">
  ...
  <?php
     $con=mysqli_connect('localhost','root');
       ...
       if (isset($_POST['search'])) {
        ...
        $sql="SELECT * FROM facultydetails where faculty_id like '%$searchKey%' or name like '$searchKey'";
       }
       else{
        $sql="SELECT * FROM facultydetails";
        $searchKey="";
...
<div class="container"> 
<br> 
<h3 class="text-center">LIST OF FACULTIES</h3><br />  
         <div class="table-responsive" id="eventmanagement">  
                     <table style="width:100%">  
                          ...
                          <tr>  
                               ...
                               <td><?php echo $rows["contact_address"]; ?></td>
                ...
                <br>
                  <div class="row">
                    <div class="col">
                      <FORM action="displayallfaculties.php" method="post">
                      <div class="input-group">
                        <input type="text" placeholder="Faculty ID or Name" aria-label="Search"
                    ...
                    <div class="col">
                      <div>
                          <button class="btn btn-dark float-right" style="align-content: right">
                            <a href="displayallfaculties.php" style="color: white;">Refresh</a>
                          </button>
                      </div>
                    </div>  
           </div>   
