...
$sql= "SELECT * FROM eventdetails ORDER BY date desc"; 
...
<div class="container"> 
<br> 
<h3 class="text-center">LIST OF EVENTS SORTED BY DATE</h3><br />  
         <div class="table-responsive" id="event_management">  
          ...
          <button class="btn btn-dark">
            <a href="displayallevents.php" style="color: white">DISPLAY ALL EVENTS</a>
          </button>  
           </div>   
</body>
</html>   
