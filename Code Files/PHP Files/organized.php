...
<html>
<head>
	<title>Add Organized Events</title>
	<meta charset="utf-8">
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<h1>Event Organized</h1>
	<div class="eventorganized">
		<form id="eventorganized" method="post" action="addorganized.php" enctype="multipart/form-data">
			<br><br><br>
			<label>Event Title:</label><br>
			<input type="text" name="etitle" placeholder="Enter Event ID" id="eid" data-required>
			<label>Faculty ID:</label><br>
			<input type="text" name="fid" placeholder="Enter Faculty ID" id="fid" data-required>
			<br><br>
			<label>Organized Event Proof:</label><br>
			<input type="file" name="organizedproof"  data-required>
			<br><br>
